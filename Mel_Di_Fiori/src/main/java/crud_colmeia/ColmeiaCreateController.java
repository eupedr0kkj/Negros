...
public class ColmeiaCreateController {
	...
	public void initialize() {
		...
		comboTipo.getItems().addAll("Langstroth", "Caixote", "Núcleo", "Caixa de papelão", "Caixa de isopor", "Outros");
	...
	private void salvarColmeia() {
		try {
			...
			alerta.setTitle("Colmeia");
			alerta.setHeaderText("Sucesso");
			alerta.setContentText("Colmeia salva com sucesso!");
			alerta.showAndWait();
			...
			alerta.setHeaderText("Falha ao salvar colmeia");
